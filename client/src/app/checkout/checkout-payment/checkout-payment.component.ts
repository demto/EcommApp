...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.stripe = Stripe('pk_test_51HX2WBIdE99gyXInIMSHAFZZVSG1OCacqKLfdQyvGKEcGh7VqQvSqFHHEbe931Hq3QIlpzxr4ABUvZCUIDiZRbE000pfWCM0SS');
  ...
  async submitOrder() {
    ...
    try {
      ...
      if (paymentResult.paymentIntent) {
        ...
        this.toasterService.error('Payment failed ' + paymentResult.error.message);
      }
